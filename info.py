...
BOT_TOKEN = environ.get('BOT_TOKEN', '8179779510:AAFeflybSNHso1c8UMQrl8vlxwLs1BNkEKI')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002566713244'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002566713244'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002566713244'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgUAAxkBAAEOcq1oH4qAKg2D3o87PFmGLSKbpWD7DAACyQoAAt2t4Vfqrx_yBOF93jYE').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002566713244'))
